...
foreach( $cats_array as $key => $value ) {
    if( $value == 1 ) {
        ...
        if( $k % 2 == 0 ) {
            $html_out .= '<tr><th class="leftbth1"><a class="ah3" href="index.php?date=' . $date . '&user=' . $key . '">';
        } else {
            $html_out .= '<tr><th class="leftbth2"><a class="ah3" href="index.php?date=' . $date . '&user=' . $key . '">';
        }
